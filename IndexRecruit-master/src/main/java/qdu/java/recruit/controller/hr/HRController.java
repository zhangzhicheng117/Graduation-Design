...
public class HRController extends BaseController{
   ...
   // @PostMapping(value = "hr/login")
    @PostMapping(value = "hr/hr_loginPost")

    public int userLogin(HttpSession httpSession,
                         @RequestParam String userName,
                         @RequestParam String userPass) throws UnsupportedEncodingException, NoSuchAlgorithmException {
        ...
        System.out.println(userName+userPass+hrService.loginHR(mobile, password));
